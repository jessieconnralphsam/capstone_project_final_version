...
foreach ($temperaturedate as $index => $date) {
    ...
    if (isset($data_tchart[$index])) {
        $chart_flow_data[] = $data_tchart[$index]['tds_readings'];
    } else {
        $chart_flow_data[] = 'N/A';
    }
}
        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Hydroponics /</span> Four-hourly Total Dissolved Solid Readings</h4>
    ...
    <script>
      ...
      (function () {
        ...
        const totalRevenueChartEl = document.querySelector('#totalRevenueChart'),
          totalRevenueChartOptions = {
            series: [
              {
                name: 'Average Water TDS(%)',
                data: [0, 0, 0, <?php echo json_encode($tds_ph); ?>, 0 ,0 ,0 ,0 ,0 ,0 ,0 ,0]
              }
            ],
            chart: {
              height: 250,
      ...
      totalRevenueChartOptions3 = {
        series: [
          {
            name: 'Average Water TDS(%)',
            data: [<?php echo json_encode($tds_ph); ?>]
          }
        ],
        chart: {
          height: 250,
